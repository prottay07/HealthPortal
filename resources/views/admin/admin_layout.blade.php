    ...
    @else
     ...
     <div class="sl-sideleft">
       ...
       <div class="sl-sideleft-menu">
         ...
         <ul class="sl-menu-sub nav flex-column">
           <li class="nav-item"><a href="{{ route('all.employee.admin') }}" class="nav-link">Employee Info</a></li>
           <li class="nav-item"><a href="{{ route('all.form.admin') }}" class="nav-link">Health Declaration</a></li>
         </ul>
