...
<div class="content-page">
  <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Employee Details Info</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="#">HNBL</a></li>
                        <li class="active">Health POrtal</li>
                    </ol>
                </div>
            </div>
...
<div class="panel panel-info">
    <div class="panel-heading"><h3 class="panel-title text-white">Employees Import
